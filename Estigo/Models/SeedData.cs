    ...
    public static class SeedData
    {
        public static void Seed (this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Course>().HasData(
                ...
                new Course { CourseId = 6, CourseTitle = "Probability | Unit 6", Description = "Exploring probability theories and applications", Price = 179, Available = true, CategoryId = 1, TeacherId = "t2", CreatedAt = seedDate, Logo = "http://est.runasp.net/prob.jpeg" },
            ...
            modelBuilder.Entity<lesson>().HasData(
                ...
                new lesson { lessonId = 1, lessonTitle = "Algebra Basics", lessonDescription = "Introduction to variables and expressions.", lessonContent = "Content covering basic algebraic notation and terminology.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 1 },
                new lesson { lessonId = 2, lessonTitle = "Solving Linear Equations", lessonDescription = "Techniques for solving single-variable linear equations.", lessonContent = "Step-by-step examples of solving linear equations.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 1 },
                new lesson { lessonId = 3, lessonTitle = "Inequalities", lessonDescription = "Understanding and solving linear inequalities.", lessonContent = "Graphing inequalities on a number line and solving.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 1 },
                new lesson { lessonId = 4, lessonTitle = "Functions Introduction", lessonDescription = "Basic concepts of functions, domain, and range.", lessonContent = "Defining functions and evaluating function values.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 1 },
                new lesson { lessonId = 5, lessonTitle = "Polynomial Basics", lessonDescription = "Introduction to polynomial expressions and operations.", lessonContent = "Adding, subtracting, and multiplying polynomials.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 1 },

                // --- Lessons for Course 2: Calculus | Unit 2 ---
                new lesson { lessonId = 6, lessonTitle = "Limits and Continuity", lessonDescription = "Understanding the concept of limits in calculus.", lessonContent = "Evaluating limits and understanding continuity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 2 },
                new lesson { lessonId = 7, lessonTitle = "Introduction to Derivatives", lessonDescription = "Defining the derivative and basic differentiation rules.", lessonContent = "Calculating derivatives using the power rule.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 2 },
                new lesson { lessonId = 8, lessonTitle = "Differentiation Techniques", lessonDescription = "Product rule, quotient rule, and chain rule.", lessonContent = "Applying advanced differentiation rules.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 2 },
                new lesson { lessonId = 9, lessonTitle = "Applications of Derivatives", lessonDescription = "Using derivatives to find rates of change and optimization.", lessonContent = "Solving related rates and optimization problems.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 2 },
                new lesson { lessonId = 10, lessonTitle = "Introduction to Integrals", lessonDescription = "Basic concepts of integration and antiderivatives.", lessonContent = "Understanding the indefinite integral.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 2 },

                // --- Lessons for Course 3: Geometry | Unit 3 ---
                new lesson { lessonId = 11, lessonTitle = "Points, Lines, and Planes", lessonDescription = "Fundamental concepts of geometry.", lessonContent = "Definitions and postulates of basic geometric elements.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 3 },
                new lesson { lessonId = 12, lessonTitle = "Angles and Angle Relationships", lessonDescription = "Types of angles and their properties.", lessonContent = "Measuring angles, complementary and supplementary angles.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 3 },
                new lesson { lessonId = 13, lessonTitle = "Parallel Lines and Transversals", lessonDescription = "Properties of angles formed by parallel lines.", lessonContent = "Identifying alternate interior, corresponding angles, etc.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 3 },
                new lesson { lessonId = 14, lessonTitle = "Triangles and Congruence", lessonDescription = "Classifying triangles and proving congruence.", lessonContent = "SSS, SAS, ASA congruence postulates.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 3 },
                new lesson { lessonId = 15, lessonTitle = "Introduction to Polygons", lessonDescription = "Properties of polygons, focusing on quadrilaterals.", lessonContent = "Calculating interior angles and classifying polygons.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 3 },

                // --- Lessons for Course 4: Trigonometry | Unit 4 ---
                new lesson { lessonId = 16, lessonTitle = "Right Triangle Trigonometry", lessonDescription = "Sine, cosine, and tangent in right triangles.", lessonContent = "SOH CAH TOA and solving right triangles.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 4 },
                new lesson { lessonId = 17, lessonTitle = "The Unit Circle", lessonDescription = "Understanding trigonometric functions using the unit circle.", lessonContent = "Finding trig values for standard angles.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 4 },
                new lesson { lessonId = 18, lessonTitle = "Trigonometric Graphs", lessonDescription = "Graphing sine, cosine, and tangent functions.", lessonContent = "Amplitude, period, and phase shift.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 4 },
                new lesson { lessonId = 19, lessonTitle = "Trigonometric Identities", lessonDescription = "Fundamental trigonometric identities.", lessonContent = "Pythagorean identities, sum/difference identities.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 4 },
                new lesson { lessonId = 20, lessonTitle = "Solving Trigonometric Equations", lessonDescription = "Techniques for solving equations involving trig functions.", lessonContent = "Finding solutions within a given interval.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 4 },

                // --- Lessons for Course 5: Statistics | Unit 5 ---
                new lesson { lessonId = 21, lessonTitle = "Introduction to Statistics", lessonDescription = "Types of data and data collection methods.", lessonContent = "Populations, samples, descriptive vs. inferential statistics.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 5 },
                new lesson { lessonId = 22, lessonTitle = "Descriptive Statistics", lessonDescription = "Measures of central tendency and dispersion.", lessonContent = "Mean, median, mode, variance, standard deviation.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 5 },
                new lesson { lessonId = 23, lessonTitle = "Data Visualization", lessonDescription = "Graphical representation of data.", lessonContent = "Histograms, box plots, scatter plots.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 5 },
                new lesson { lessonId = 24, lessonTitle = "Basic Probability Concepts", lessonDescription = "Introduction to probability rules.", lessonContent = "Sample spaces, events, conditional probability.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 5 },
                new lesson { lessonId = 25, lessonTitle = "Introduction to Distributions", lessonDescription = "Understanding probability distributions.", lessonContent = "Binomial and Normal distributions basics.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 5 },

                // --- Lessons for Course 6: Probability | Unit 6 ---
                new lesson { lessonId = 26, lessonTitle = "Foundations of Probability", lessonDescription = "Axioms of probability and sample spaces.", lessonContent = "Defining events and calculating basic probabilities.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 6 },
                new lesson { lessonId = 27, lessonTitle = "Conditional Probability and Independence", lessonDescription = "Understanding dependent and independent events.", lessonContent = "Bayes' Theorem and its applications.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 6 },
                new lesson { lessonId = 28, lessonTitle = "Random Variables", lessonDescription = "Discrete and continuous random variables.", lessonContent = "Probability mass functions and density functions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 6 },
                new lesson { lessonId = 29, lessonTitle = "Expected Value and Variance", lessonDescription = "Calculating measures for random variables.", lessonContent = "Properties of expectation and variance.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 6 },
                new lesson { lessonId = 30, lessonTitle = "Common Probability Distributions", lessonDescription = "Detailed look at Binomial, Poisson, Normal distributions.", lessonContent = "Applications and calculations for common distributions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 6 },

                // --- Lessons for Course 7: Discrete Math | Unit 7 ---
                new lesson { lessonId = 31, lessonTitle = "Logic and Proofs", lessonDescription = "Propositional logic and methods of proof.", lessonContent = "Truth tables, logical equivalences, direct proof, proof by contradiction.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 7 },
                new lesson { lessonId = 32, lessonTitle = "Set Theory", lessonDescription = "Operations on sets, Venn diagrams.", lessonContent = "Union, intersection, complement, power sets.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 7 },
                new lesson { lessonId = 33, lessonTitle = "Counting Principles", lessonDescription = "Permutations and combinations.", lessonContent = "The pigeonhole principle, binomial coefficients.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 7 },
                new lesson { lessonId = 34, lessonTitle = "Relations and Functions", lessonDescription = "Properties of relations and types of functions.", lessonContent = "Equivalence relations, injective, surjective functions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 7 },
                new lesson { lessonId = 35, lessonTitle = "Introduction to Graph Theory", lessonDescription = "Basic concepts of graphs and trees.", lessonContent = "Vertices, edges, paths, cycles, graph coloring.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 7 },

                // --- Lessons for Course 8: Mechanics | Unit 1 ---
                new lesson { lessonId = 36, lessonTitle = "Kinematics in One Dimension", lessonDescription = "Motion, velocity, and acceleration.", lessonContent = "Equations of motion for constant acceleration.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 8 },
                new lesson { lessonId = 37, lessonTitle = "Vectors and 2D Kinematics", lessonDescription = "Projectile motion and vector operations.", lessonContent = "Adding vectors, resolving vectors into components.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 8 },
                new lesson { lessonId = 38, lessonTitle = "Newton's Laws of Motion", lessonDescription = "Force, mass, and acceleration.", lessonContent = "Applying Newton's first, second, and third laws.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 8 },
                new lesson { lessonId = 39, lessonTitle = "Work, Energy, and Power", lessonDescription = "Concepts of work, kinetic and potential energy.", lessonContent = "Conservation of energy principle.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 8 },
                new lesson { lessonId = 40, lessonTitle = "Momentum and Collisions", lessonDescription = "Linear momentum and impulse.", lessonContent = "Conservation of momentum in collisions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 8 },

                // --- Lessons for Course 9: Electricity | Unit 2 ---
                new lesson { lessonId = 41, lessonTitle = "Electric Charge and Coulomb's Law", lessonDescription = "Properties of electric charge and forces between charges.", lessonContent = "Calculating electrostatic forces.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 9 },
                new lesson { lessonId = 42, lessonTitle = "Electric Fields", lessonDescription = "Concept of the electric field and field lines.", lessonContent = "Calculating electric fields for point charges.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 9 },
                new lesson { lessonId = 43, lessonTitle = "Electric Potential", lessonDescription = "Potential difference and electric potential energy.", lessonContent = "Calculating potential for point charges and systems.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 9 },
                new lesson { lessonId = 44, lessonTitle = "Capacitance", lessonDescription = "Capacitors and energy storage.", lessonContent = "Calculating capacitance for parallel plate capacitors.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 9 },
                new lesson { lessonId = 45, lessonTitle = "Current, Resistance, and Ohm's Law", lessonDescription = "Basics of electric current and resistance.", lessonContent = "Applying Ohm's Law to simple circuits.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 9 },

                // --- Lessons for Course 10: Magnetism | Unit 3 ---
                new lesson { lessonId = 46, lessonTitle = "Magnetic Fields and Forces", lessonDescription = "Introduction to magnetic fields and forces on moving charges.", lessonContent = "Calculating magnetic force using the Lorentz force law.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 10 },
                new lesson { lessonId = 47, lessonTitle = "Sources of Magnetic Fields", lessonDescription = "Magnetic fields produced by currents (Biot-Savart Law).", lessonContent = "Calculating fields for wires and loops.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 10 },
                new lesson { lessonId = 48, lessonTitle = "Ampere's Law", lessonDescription = "Using Ampere's Law to find magnetic fields.", lessonContent = "Applications for solenoids and toroids.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 10 },
                new lesson { lessonId = 49, lessonTitle = "Electromagnetic Induction", lessonDescription = "Faraday's Law of Induction and Lenz's Law.", lessonContent = "Induced EMF and magnetic flux.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 10 },
                new lesson { lessonId = 50, lessonTitle = "Inductance", lessonDescription = "Self-inductance and mutual inductance.", lessonContent = "RL circuits and energy stored in inductors.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 10 },

                // --- Lessons for Course 11: Optics | Unit 4 ---
                new lesson { lessonId = 51, lessonTitle = "Nature of Light", lessonDescription = "Wave-particle duality and the electromagnetic spectrum.", lessonContent = "Properties of light waves.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 11 },
                new lesson { lessonId = 52, lessonTitle = "Reflection and Refraction", lessonDescription = "Laws of reflection and Snell's Law of refraction.", lessonContent = "Total internal reflection and index of refraction.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 11 },
                new lesson { lessonId = 53, lessonTitle = "Lenses and Image Formation", lessonDescription = "Converging and diverging lenses.", lessonContent = "Ray tracing and the thin lens equation.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 11 },
                new lesson { lessonId = 54, lessonTitle = "Wave Optics: Interference", lessonDescription = "Principle of superposition and interference patterns.", lessonContent = "Young's double-slit experiment.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 11 },
                new lesson { lessonId = 55, lessonTitle = "Wave Optics: Diffraction", lessonDescription = "Diffraction of light through slits and gratings.", lessonContent = "Single-slit diffraction patterns.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 11 },

                // --- Lessons for Course 12: Thermodynamics | Unit 5 ---
                new lesson { lessonId = 56, lessonTitle = "Temperature and Heat", lessonDescription = "Concepts of thermal energy, temperature scales, and heat transfer.", lessonContent = "Specific heat and calorimetry.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 12 },
                new lesson { lessonId = 57, lessonTitle = "First Law of Thermodynamics", lessonDescription = "Internal energy, work, and heat in thermodynamic processes.", lessonContent = "Conservation of energy in thermal systems.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 12 },
                new lesson { lessonId = 58, lessonTitle = "Ideal Gas Law", lessonDescription = "Behavior of ideal gases.", lessonContent = "PV=nRT and kinetic theory of gases.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 12 },
                new lesson { lessonId = 59, lessonTitle = "Second Law of Thermodynamics", lessonDescription = "Entropy and the direction of thermodynamic processes.", lessonContent = "Heat engines and refrigerators.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 12 },
                new lesson { lessonId = 60, lessonTitle = "Thermodynamic Cycles", lessonDescription = "Analyzing cycles like the Carnot cycle.", lessonContent = "Efficiency of heat engines.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 12 },

                // --- Lessons for Course 13: Quantum Physics | Unit 6 ---
                new lesson { lessonId = 61, lessonTitle = "Blackbody Radiation & Planck's Hypothesis", lessonDescription = "The ultraviolet catastrophe and quantization of energy.", lessonContent = "Planck's constant and energy quanta.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 13 },
                new lesson { lessonId = 62, lessonTitle = "Photoelectric Effect", lessonDescription = "Einstein's explanation and the particle nature of light.", lessonContent = "Work function and stopping potential.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 13 },
                new lesson { lessonId = 63, lessonTitle = "Wave Nature of Matter", lessonDescription = "De Broglie hypothesis and matter waves.", lessonContent = "Electron diffraction experiments.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 13 },
                new lesson { lessonId = 64, lessonTitle = "The Bohr Model", lessonDescription = "Early model of the hydrogen atom.", lessonContent = "Quantized energy levels and spectral lines.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 13 },
                new lesson { lessonId = 65, lessonTitle = "Introduction to Quantum Mechanics", lessonDescription = "The Schrödinger equation and wave functions.", lessonContent = "Probability interpretation and uncertainty principle.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 13 },

                // --- Lessons for Course 14: Relativity | Unit 7 ---
                new lesson { lessonId = 66, lessonTitle = "Principles of Special Relativity", lessonDescription = "Postulates of special relativity.", lessonContent = "Inertial frames and the constancy of the speed of light.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 14 },
                new lesson { lessonId = 67, lessonTitle = "Time Dilation and Length Contraction", lessonDescription = "Consequences of special relativity.", lessonContent = "Relativistic effects on time and space.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 14 },
                new lesson { lessonId = 68, lessonTitle = "Relativistic Momentum and Energy", lessonDescription = "Modifications to classical momentum and energy.", lessonContent = "E=mc² and its implications.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 14 },
                new lesson { lessonId = 69, lessonTitle = "Introduction to General Relativity", lessonDescription = "Principle of equivalence and gravity as spacetime curvature.", lessonContent = "Conceptual overview of general relativity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 14 },
                new lesson { lessonId = 70, lessonTitle = "Consequences of General Relativity", lessonDescription = "Gravitational lensing, black holes, and gravitational waves.", lessonContent = "Observational evidence for general relativity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 14 },

                // --- Lessons for Course 15: Cell Biology | Unit 1 ---
                new lesson { lessonId = 71, lessonTitle = "Introduction to Cells", lessonDescription = "Prokaryotic vs. Eukaryotic cells.", lessonContent = "Basic cell structures and functions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 15 },
                new lesson { lessonId = 72, lessonTitle = "Cell Membrane Structure and Function", lessonDescription = "The fluid mosaic model and transport mechanisms.", lessonContent = "Passive transport, active transport, endocytosis.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 15 },
                new lesson { lessonId = 73, lessonTitle = "Eukaryotic Organelles", lessonDescription = "Structure and function of major organelles.", lessonContent = "Nucleus, mitochondria, chloroplasts, ER, Golgi.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 15 },
                new lesson { lessonId = 74, lessonTitle = "Cellular Respiration", lessonDescription = "Overview of energy production in cells.", lessonContent = "Glycolysis, Krebs cycle, electron transport chain.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 15 },
                new lesson { lessonId = 75, lessonTitle = "The Cell Cycle and Mitosis", lessonDescription = "Phases of the cell cycle and cell division.", lessonContent = "Interphase, prophase, metaphase, anaphase, telophase.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 15 },

                // --- Lessons for Course 16: Genetics | Unit 2 ---
                new lesson { lessonId = 76, lessonTitle = "Mendelian Genetics", lessonDescription = "Principles of inheritance discovered by Mendel.", lessonContent = "Dominance, segregation, independent assortment.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 16 },
                new lesson { lessonId = 77, lessonTitle = "DNA Structure and Replication", lessonDescription = "The double helix structure and DNA synthesis.", lessonContent = "Base pairing rules, enzymes involved in replication.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 16 },
                new lesson { lessonId = 78, lessonTitle = "Gene Expression: Transcription", lessonDescription = "From DNA to RNA.", lessonContent = "Process of transcription, RNA polymerase.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 16 },
                new lesson { lessonId = 79, lessonTitle = "Gene Expression: Translation", lessonDescription = "From RNA to Protein.", lessonContent = "Ribosomes, codons, tRNA, protein synthesis.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 16 },
                new lesson { lessonId = 80, lessonTitle = "Mutations and Genetic Variation", lessonDescription = "Types of mutations and their effects.", lessonContent = "Point mutations, chromosomal mutations, sources of variation.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 16 },

                // --- Lessons for Course 17: Movement | Unit 3 ---
                new lesson { lessonId = 81, lessonTitle = "Skeletal Systems", lessonDescription = "Types of skeletons and bone structure.", lessonContent = "Human skeleton overview, bone composition.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 17 },
                new lesson { lessonId = 82, lessonTitle = "Muscular Systems", lessonDescription = "Types of muscles and muscle contraction.", lessonContent = "Skeletal, smooth, cardiac muscle; sliding filament theory.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 17 },
                new lesson { lessonId = 83, lessonTitle = "Biomechanics Basics", lessonDescription = "Forces and levers in biological systems.", lessonContent = "Analyzing movement from a mechanical perspective.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 17 },
                new lesson { lessonId = 84, lessonTitle = "Locomotion in Animals", lessonDescription = "Different modes of animal movement.", lessonContent = "Walking, running, swimming, flying adaptations.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 17 },
                new lesson { lessonId = 85, lessonTitle = "Nervous System Control of Movement", lessonDescription = "How the nervous system coordinates muscle action.", lessonContent = "Motor neurons, reflexes, brain control centers.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 17 },

                // --- Lessons for Course 18: Ecology | Unit 4 ---
                new lesson { lessonId = 86, lessonTitle = "Introduction to Ecology", lessonDescription = "Levels of ecological organization.", lessonContent = "Organisms, populations, communities, ecosystems, biosphere.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 18 },
                new lesson { lessonId = 87, lessonTitle = "Population Ecology", lessonDescription = "Population growth models and limiting factors.", lessonContent = "Exponential and logistic growth, carrying capacity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 18 },
                new lesson { lessonId = 88, lessonTitle = "Community Ecology", lessonDescription = "Species interactions within communities.", lessonContent = "Competition, predation, symbiosis, biodiversity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 18 },
                new lesson { lessonId = 89, lessonTitle = "Ecosystem Dynamics", lessonDescription = "Energy flow and nutrient cycling.", lessonContent = "Food webs, trophic levels, biogeochemical cycles.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 18 },
                new lesson { lessonId = 90, lessonTitle = "Biomes and Conservation", lessonDescription = "Major terrestrial and aquatic biomes.", lessonContent = "Threats to biodiversity and conservation efforts.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 18 },

                // --- Lessons for Course 19: Botany | Unit 5 ---
                new lesson { lessonId = 91, lessonTitle = "Plant Structure and Growth", lessonDescription = "Basic anatomy of plants: roots, stems, leaves.", lessonContent = "Meristems and primary/secondary growth.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 19 },
                new lesson { lessonId = 92, lessonTitle = "Plant Transport Systems", lessonDescription = "Water and nutrient transport in plants.", lessonContent = "Xylem, phloem, transpiration.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 19 },
                new lesson { lessonId = 93, lessonTitle = "Photosynthesis", lessonDescription = "The process of converting light energy to chemical energy.", lessonContent = "Light-dependent reactions and the Calvin cycle.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 19 },
                new lesson { lessonId = 94, lessonTitle = "Plant Reproduction", lessonDescription = "Asexual and sexual reproduction in plants.", lessonContent = "Flower structure, pollination, fertilization, seed development.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 19 },
                new lesson { lessonId = 95, lessonTitle = "Plant Hormones and Responses", lessonDescription = "Chemical signaling in plants.", lessonContent = "Auxins, gibberellins, phototropism, gravitropism.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 19 },

                // --- Lessons for Course 20: Zoology | Unit 6 ---
                new lesson { lessonId = 96, lessonTitle = "Introduction to Animal Diversity", lessonDescription = "Major animal phyla and characteristics.", lessonContent = "Body plans, symmetry, evolutionary relationships.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 20 },
                new lesson { lessonId = 97, lessonTitle = "Invertebrate Zoology I", lessonDescription = "Focus on simpler invertebrates.", lessonContent = "Sponges, cnidarians, flatworms, roundworms.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 20 },
                new lesson { lessonId = 98, lessonTitle = "Invertebrate Zoology II", lessonDescription = "Focus on more complex invertebrates.", lessonContent = "Mollusks, annelids, arthropods, echinoderms.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 20 },
                new lesson { lessonId = 99, lessonTitle = "Vertebrate Zoology I", lessonDescription = "Introduction to Chordates and Fish.", lessonContent = "Characteristics of chordates, evolution of fish.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 20 },
                new lesson { lessonId = 100, lessonTitle = "Vertebrate Zoology II", lessonDescription = "Amphibians, Reptiles, Birds, and Mammals.", lessonContent = "Key characteristics and adaptations of terrestrial vertebrates.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 20 },

                // --- Lessons for Course 21: Microbiology | Unit 7 ---
                new lesson { lessonId = 101, lessonTitle = "Introduction to Microbes", lessonDescription = "Overview of bacteria, archaea, viruses, fungi, protists.", lessonContent = "Microbial diversity and history of microbiology.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 21 },
                new lesson { lessonId = 102, lessonTitle = "Bacterial Structure and Function", lessonDescription = "Cell walls, flagella, capsules, endospores.", lessonContent = "Gram staining and bacterial morphology.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 21 },
                new lesson { lessonId = 103, lessonTitle = "Microbial Growth and Metabolism", lessonDescription = "Requirements for growth, growth curve, metabolic pathways.", lessonContent = "Binary fission, nutritional types.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 21 },
                new lesson { lessonId = 104, lessonTitle = "Viruses and Prions", lessonDescription = "Structure, replication cycles, and characteristics.", lessonContent = "Lytic vs. lysogenic cycles, viral diseases.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 21 },
                new lesson { lessonId = 105, lessonTitle = "Microbial Roles and Applications", lessonDescription = "Microbes in ecosystems, disease, and industry.", lessonContent = "Pathogens, decomposers, biotechnology.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 21 },

                // --- Lessons for Course 22: Organic Chemistry | Unit 1 ---
                new lesson { lessonId = 106, lessonTitle = "Introduction & Bonding", lessonDescription = "Structure, bonding, and properties of organic molecules.", lessonContent = "Lewis structures, VSEPR theory, hybridization.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 22 },
                new lesson { lessonId = 107, lessonTitle = "Alkanes and Cycloalkanes", lessonDescription = "Nomenclature and conformations.", lessonContent = "Naming alkanes (IUPAC), Newman projections.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 22 },
                new lesson { lessonId = 108, lessonTitle = "Stereochemistry", lessonDescription = "Chirality, enantiomers, diastereomers.", lessonContent = "R/S configuration, optical activity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 22 },
                new lesson { lessonId = 109, lessonTitle = "Introduction to Organic Reactions", lessonDescription = "Reaction types, mechanisms, and thermodynamics.", lessonContent = "Arrows formalism, reaction energy diagrams.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 22 },
                new lesson { lessonId = 110, lessonTitle = "Alkenes and Alkynes: Structure & Reactivity", lessonDescription = "Structure, nomenclature, and introduction to addition reactions.", lessonContent = "Pi bonds, electrophilic addition basics.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 22 },

                // --- Lessons for Course 23: Inorganic Chemistry | Unit 2 ---
                new lesson { lessonId = 111, lessonTitle = "Atomic Structure and Periodicity", lessonDescription = "Review of atomic models and periodic trends.", lessonContent = "Electron configurations, ionization energy, electronegativity.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 23 },
                new lesson { lessonId = 112, lessonTitle = "Chemical Bonding: Lewis & VSEPR", lessonDescription = "Ionic and covalent bonding theories.", lessonContent = "Predicting molecular geometry.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 23 },
                new lesson { lessonId = 113, lessonTitle = "Valence Bond and Molecular Orbital Theory", lessonDescription = "Advanced bonding theories.", lessonContent = "Hybridization, MO diagrams for diatomic molecules.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 23 },
                new lesson { lessonId = 114, lessonTitle = "Acid-Base Chemistry", lessonDescription = "Bronsted-Lowry and Lewis definitions.", lessonContent = "Acid strength, hard/soft acids and bases.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 23 },
                new lesson { lessonId = 115, lessonTitle = "Introduction to Coordination Chemistry", lessonDescription = "Transition metals, ligands, and complex ions.", lessonContent = "Nomenclature and basic structures.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 23 },

                // --- Lessons for Course 24: Physical Chemistry | Unit 3 ---
                new lesson { lessonId = 116, lessonTitle = "Gases and Kinetic Theory", lessonDescription = "Ideal and real gas behavior.", lessonContent = "Gas laws, Maxwell-Boltzmann distribution.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 24 },
                new lesson { lessonId = 117, lessonTitle = "Thermodynamics: First Law", lessonDescription = "Energy, work, heat, enthalpy.", lessonContent = "State functions, calorimetry.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 24 },
                new lesson { lessonId = 118, lessonTitle = "Thermodynamics: Second & Third Laws", lessonDescription = "Entropy, spontaneity, Gibbs free energy.", lessonContent = "Calculating entropy changes, absolute entropy.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 24 },
                new lesson { lessonId = 119, lessonTitle = "Chemical Kinetics", lessonDescription = "Reaction rates and mechanisms.", lessonContent = "Rate laws, activation energy, Arrhenius equation.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 24 },
                new lesson { lessonId = 120, lessonTitle = "Introduction to Quantum Chemistry", lessonDescription = "Basic principles and applications.", lessonContent = "Particle in a box, hydrogen atom basics.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 24 },

                // --- Lessons for Course 25: Analytical Chemistry | Unit 4 ---
                new lesson { lessonId = 121, lessonTitle = "Introduction & Statistics", lessonDescription = "Role of analytical chemistry, errors, and data analysis.", lessonContent = "Significant figures, precision vs. accuracy, basic stats.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 25 },
                new lesson { lessonId = 122, lessonTitle = "Gravimetric and Volumetric Analysis", lessonDescription = "Classical methods of analysis.", lessonContent = "Precipitation methods, titration techniques.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 25 },
                new lesson { lessonId = 123, lessonTitle = "Spectroscopic Methods", lessonDescription = "Interaction of light and matter.", lessonContent = "UV-Vis spectroscopy, Beer-Lambert Law.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 25 },
                new lesson { lessonId = 124, lessonTitle = "Chromatography Basics", lessonDescription = "Principles of separation techniques.", lessonContent = "Gas chromatography (GC) and Liquid chromatography (LC) overview.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 25 },
                new lesson { lessonId = 125, lessonTitle = "Electroanalytical Methods", lessonDescription = "Techniques based on electrical properties.", lessonContent = "Potentiometry, voltammetry basics.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 25 },

                // --- Lessons for Course 26: Biochemistry | Unit 5 ---
                new lesson { lessonId = 126, lessonTitle = "Amino Acids and Proteins", lessonDescription = "Structure and properties of amino acids and protein hierarchy.", lessonContent = "Peptide bonds, primary to quaternary structure.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 26 },
                new lesson { lessonId = 127, lessonTitle = "Enzymes and Enzyme Kinetics", lessonDescription = "Biological catalysts and reaction rates.", lessonContent = "Michaelis-Menten kinetics, enzyme inhibition.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 26 },
                new lesson { lessonId = 128, lessonTitle = "Carbohydrates", lessonDescription = "Structure and function of monosaccharides and polysaccharides.", lessonContent = "Glycosidic bonds, common sugars.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 26 },
                new lesson { lessonId = 129, lessonTitle = "Lipids and Membranes", lessonDescription = "Types of lipids and biological membrane structure.", lessonContent = "Fatty acids, triglycerides, phospholipids, fluid mosaic model.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 26 },
                new lesson { lessonId = 130, lessonTitle = "Metabolic Pathways Overview", lessonDescription = "Introduction to major pathways like glycolysis.", lessonContent = "Anabolism vs. catabolism, ATP production.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 26 },

                // --- Lessons for Course 27: Environmental Chemistry | Unit 6 ---
                new lesson { lessonId = 131, lessonTitle = "Atmospheric Chemistry", lessonDescription = "Composition and reactions in the atmosphere.", lessonContent = "Ozone layer, greenhouse effect, air pollution.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 27 },
                new lesson { lessonId = 132, lessonTitle = "Aquatic Chemistry", lessonDescription = "Chemical processes in water bodies.", lessonContent = "Water quality parameters (pH, DO), water pollution.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 27 },
                new lesson { lessonId = 133, lessonTitle = "Soil Chemistry", lessonDescription = "Composition and chemical reactions in soil.", lessonContent = "Nutrient cycles, soil contamination.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 27 },
                new lesson { lessonId = 134, lessonTitle = "Toxicology and Risk Assessment", lessonDescription = "Effects of chemicals on organisms and ecosystems.", lessonContent = "Dose-response relationships, environmental risk.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 27 },
                new lesson { lessonId = 135, lessonTitle = "Green Chemistry", lessonDescription = "Principles for designing safer chemical processes.", lessonContent = "Waste reduction, sustainable chemistry practices.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 27 },

                // --- Lessons for Course 28: Theoretical Chemistry | Unit 7 ---
                new lesson { lessonId = 136, lessonTitle = "Quantum Mechanics Fundamentals", lessonDescription = "Postulates and mathematical framework.", lessonContent = "Operators, eigenfunctions, eigenvalues.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 28 },
                new lesson { lessonId = 137, lessonTitle = "Approximation Methods", lessonDescription = "Techniques for solving the Schrödinger equation.", lessonContent = "Variation principle, perturbation theory.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 28 },
                new lesson { lessonId = 138, lessonTitle = "Molecular Symmetry and Group Theory", lessonDescription = "Using symmetry to simplify chemical problems.", lessonContent = "Point groups, character tables.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 28 },
                new lesson { lessonId = 139, lessonTitle = "Computational Chemistry Methods", lessonDescription = "Overview of computational techniques.", lessonContent = "Hartree-Fock, Density Functional Theory (DFT) basics.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 28 },
                new lesson { lessonId = 140, lessonTitle = "Statistical Thermodynamics", lessonDescription = "Connecting microscopic properties to macroscopic behavior.", lessonContent = "Partition functions, ensemble theory.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 28 },

                // --- Lessons for Course 29: Literature | Unit 1 ---
                new lesson { lessonId = 141, lessonTitle = "Introduction to Literary Analysis", lessonDescription = "Tools and techniques for interpreting literature.", lessonContent = "Theme, plot, character, setting, point of view.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 29 },
                new lesson { lessonId = 142, lessonTitle = "Short Story Analysis", lessonDescription = "Analyzing elements of short fiction.", lessonContent = "Examining notable short stories.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 29 },
                new lesson { lessonId = 143, lessonTitle = "Poetry Fundamentals", lessonDescription = "Understanding poetic devices and forms.", lessonContent = "Meter, rhyme, imagery, metaphor, sonnets.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 29 },
                new lesson { lessonId = 144, lessonTitle = "Novel Study: Introduction", lessonDescription = "Approaches to reading and analyzing novels.", lessonContent = "Context, structure, and major themes in a sample novel.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 29 },
                new lesson { lessonId = 145, lessonTitle = "Introduction to Drama", lessonDescription = "Elements of dramatic literature.", lessonContent = "Dialogue, stage directions, character arcs in plays.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 29 },

                // --- Lessons for Course 30: Creative Writing | Unit 2 ---
                new lesson { lessonId = 146, lessonTitle = "Finding Your Voice", lessonDescription = "Developing a unique writing style.", lessonContent = "Exercises in tone, perspective, and style.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 30 },
                new lesson { lessonId = 147, lessonTitle = "Character Development", lessonDescription = "Creating believable and engaging characters.", lessonContent = "Character archetypes, backstory, motivations.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 30 },
                new lesson { lessonId = 148, lessonTitle = "Plotting and Structure", lessonDescription = "Crafting compelling narratives.", lessonContent = "Three-act structure, outlining techniques, pacing.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 30 },
                new lesson { lessonId = 149, lessonTitle = "Setting and Description", lessonDescription = "Building immersive worlds.", lessonContent = "Using sensory details, creating atmosphere.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 30 },
                new lesson { lessonId = 150, lessonTitle = "Dialogue Writing", lessonDescription = "Writing effective and natural dialogue.", lessonContent = "Subtext, character voice in dialogue, formatting.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 30 },

                // --- Lessons for Course 31: Grammar & Composition | Unit 3 ---
                new lesson { lessonId = 151, lessonTitle = "Parts of Speech Review", lessonDescription = "Understanding nouns, verbs, adjectives, etc.", lessonContent = "Identifying parts of speech in sentences.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 31 },
                new lesson { lessonId = 152, lessonTitle = "Sentence Structure", lessonDescription = "Clauses, phrases, and sentence types.", lessonContent = "Simple, compound, complex, compound-complex sentences.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 31 },
                new lesson { lessonId = 153, lessonTitle = "Punctuation Rules", lessonDescription = "Correct usage of commas, semicolons, apostrophes, etc.", lessonContent = "Common punctuation errors and fixes.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 31 },
                new lesson { lessonId = 154, lessonTitle = "Common Grammatical Errors", lessonDescription = "Subject-verb agreement, pronoun usage, modifiers.", lessonContent = "Identifying and correcting frequent mistakes.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 31 },
                new lesson { lessonId = 155, lessonTitle = "Paragraph and Essay Structure", lessonDescription = "Organizing ideas effectively.", lessonContent = "Topic sentences, transitions, thesis statements.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 31 },

                // --- Lessons for Course 32: Poetry Analysis | Unit 4 ---
                new lesson { lessonId = 156, lessonTitle = "Elements of Poetry", lessonDescription = "Rhythm, meter, rhyme schemes.", lessonContent = "Scanning poetry, identifying different meters.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 32 },
                new lesson { lessonId = 157, lessonTitle = "Figurative Language", lessonDescription = "Metaphor, simile, personification, hyperbole.", lessonContent = "Identifying and interpreting figurative language.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 32 },
                new lesson { lessonId = 158, lessonTitle = "Sound Devices", lessonDescription = "Alliteration, assonance, consonance, onomatopoeia.", lessonContent = "Analyzing the musicality of poetry.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 32 },
                new lesson { lessonId = 159, lessonTitle = "Poetic Forms", lessonDescription = "Sonnets, haikus, villanelles, free verse.", lessonContent = "Recognizing and analyzing different poetic structures.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 32 },
                new lesson { lessonId = 160, lessonTitle = "Interpreting Poems", lessonDescription = "Developing analytical arguments about poetry.", lessonContent = "Close reading techniques and thematic analysis.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 32 },

                // --- Lessons for Course 33: Drama & Theater | Unit 5 ---
                new lesson { lessonId = 161, lessonTitle = "History of Theater", lessonDescription = "From ancient Greek tragedy to modern drama.", lessonContent = "Key periods and influential playwrights.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 33 },
                new lesson { lessonId = 162, lessonTitle = "Elements of Drama", lessonDescription = "Plot, character, theme, dialogue, spectacle.", lessonContent = "Aristotle's Poetics and dramatic structure.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 33 },
                new lesson { lessonId = 163, lessonTitle = "Reading a Play", lessonDescription = "Understanding stage directions and subtext.", lessonContent = "Visualizing the play and interpreting character motivations.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 33 },
                new lesson { lessonId = 164, lessonTitle = "Major Dramatic Genres", lessonDescription = "Tragedy, comedy, tragicomedy, melodrama.", lessonContent = "Characteristics and examples of different genres.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 33 },
                new lesson { lessonId = 165, lessonTitle = "Theater Production Basics", lessonDescription = "Roles in theater (director, actor, designer).", lessonContent = "Overview of the process from script to stage.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 33 },

                // --- Lessons for Course 34: Fiction Writing | Unit 6 ---
                new lesson { lessonId = 166, lessonTitle = "Generating Ideas", lessonDescription = "Finding inspiration for fiction stories.", lessonContent = "Brainstorming techniques, prompts, observation.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 34 },
                new lesson { lessonId = 167, lessonTitle = "Point of View and Narrative Voice", lessonDescription = "Choosing the right perspective (1st, 3rd limited/omniscient).", lessonContent = "Impact of POV choices on the story.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 34 },
                new lesson { lessonId = 168, lessonTitle = "Show, Don't Tell", lessonDescription = "Using concrete details to engage readers.", lessonContent = "Techniques for showing emotion and action.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 34 },
                new lesson { lessonId = 169, lessonTitle = "Crafting Scenes", lessonDescription = "Building blocks of a story.", lessonContent = "Scene structure, pacing within scenes, transitions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 34 },
                new lesson { lessonId = 170, lessonTitle = "Revision Strategies", lessonDescription = "Techniques for improving a draft.", lessonContent = "Self-editing, seeking feedback, common pitfalls.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 34 },

                // --- Lessons for Course 35: Non-fiction Writing | Unit 7 ---
                new lesson { lessonId = 171, lessonTitle = "Types of Non-fiction", lessonDescription = "Memoir, biography, essays, journalism.", lessonContent = "Understanding different forms and their conventions.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 35 },
                new lesson { lessonId = 172, lessonTitle = "Research Techniques", lessonDescription = "Gathering information for non-fiction.", lessonContent = "Interviews, archival research, evaluating sources.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 35 },
                new lesson { lessonId = 173, lessonTitle = "Structuring Non-fiction", lessonDescription = "Organizing factual material effectively.", lessonContent = "Chronological, thematic, and narrative structures.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 35 },
                new lesson { lessonId = 174, lessonTitle = "Writing with Clarity and Style", lessonDescription = "Engaging readers with factual content.", lessonContent = "Using vivid language, maintaining accuracy.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 35 },
                new lesson { lessonId = 175, lessonTitle = "Ethics in Non-fiction", lessonDescription = "Responsibilities when writing about real people and events.", lessonContent = "Fact-checking, privacy concerns, representation.", lessonVideo = "http://est.runasp.net/vv.mp4", courseId = 35 }
            );
