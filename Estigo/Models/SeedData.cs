...
namespace Estigo.Models
{
    ...
    new Course { courseId = 35, CourseTitle = "Non-fiction Writing | Unit 7", Description = "Crafting engaging non-fiction narratives", Price = 119, Available = true, CategoryId = 5, TeacherId = "290f0fe9-c8cb-4a6e-b863-b61df939f025", CreatedAt = seedDate, Logo = "https://estigo.runasp.net/m7.jpg", Status = approvedStatus }
            ...
            modelBuilder.Entity<lesson>().HasData(
                ...
                new lesson { lessonId = 1, lessonTitle = "Algebra Basics", lessonVideo = "https://estigo.runasp.net/intro.mp4", courseId = 1 },
                new lesson { lessonId = 2, lessonTitle = "Solving Linear Equations", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 1 },
                new lesson { lessonId = 3, lessonTitle = "Inequalities", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 1 },
                new lesson { lessonId = 4, lessonTitle = "Functions Introduction", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 1 },
                new lesson { lessonId = 5, lessonTitle = "Polynomial Basics", lessonVideo = "https://estigo.runasp.net/math4.mp4", courseId = 1 },

                // --- Lessons for Course 2: Calculus | Unit 2 ---
                new lesson { lessonId = 6, lessonTitle = "Limits and Continuity", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 2 },
                new lesson { lessonId = 7, lessonTitle = "Introduction to Derivatives", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 2 },
                new lesson { lessonId = 8, lessonTitle = "Differentiation Techniques", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 2 },
                new lesson { lessonId = 9, lessonTitle = "Applications of Derivatives", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 2 },
                new lesson { lessonId = 10, lessonTitle = "Introduction to Integrals", lessonVideo = "https://estigo.runasp.net/math4.mp4", courseId = 2 },

                // --- Lessons for Course 3: Geometry | Unit 3 ---
                new lesson { lessonId = 11, lessonTitle = "Points, Lines, and Planes", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 3 },
                new lesson { lessonId = 12, lessonTitle = "Angles and Angle Relationships", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 3 },
                new lesson { lessonId = 13, lessonTitle = "Parallel Lines and Transversals", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 3 },
                new lesson { lessonId = 14, lessonTitle = "Triangles and Congruence", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 3 },
                new lesson { lessonId = 15, lessonTitle = "Introduction to Polygons", lessonVideo = "https://estigo.runasp.net/math4.mp4", courseId = 3 },

                // --- Lessons for Course 4: Trigonometry | Unit 4 ---
                new lesson { lessonId = 16, lessonTitle = "Right Triangle Trigonometry", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 4 },
                new lesson { lessonId = 17, lessonTitle = "The Unit Circle", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 4 },
                new lesson { lessonId = 18, lessonTitle = "Trigonometric Graphs", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 4 },
                new lesson { lessonId = 19, lessonTitle = "Trigonometric Identities", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 4 },
                new lesson { lessonId = 20, lessonTitle = "Solving Trigonometric Equations", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 4 },

                // --- Lessons for Course 5: Statistics | Unit 5 ---
                new lesson { lessonId = 21, lessonTitle = "Introduction to Statistics", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 5 },
                new lesson { lessonId = 22, lessonTitle = "Descriptive Statistics", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 5 },
                new lesson { lessonId = 23, lessonTitle = "Data Visualization", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 5 },
                new lesson { lessonId = 24, lessonTitle = "Basic Probability Concepts", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 5 },
                new lesson { lessonId = 25, lessonTitle = "Introduction to Distributions", lessonVideo = "https://estigo.runasp.net/math4.mp4", courseId = 5 },

                // --- Lessons for Course 6: Probability | Unit 6 ---
                new lesson { lessonId = 26, lessonTitle = "Foundations of Probability", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 6 },
                new lesson { lessonId = 27, lessonTitle = "Conditional Probability and Independence", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 6 },
                new lesson { lessonId = 28, lessonTitle = "Random Variables", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 6 },
                new lesson { lessonId = 29, lessonTitle = "Expected Value and Variance", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 6 },
                new lesson { lessonId = 30, lessonTitle = "Common Probability Distributions", lessonVideo = "https://estigo.runasp.net/math4.mp4", courseId = 6 },

                // --- Lessons for Course 7: Discrete Math | Unit 7 ---
                new lesson { lessonId = 31, lessonTitle = "Logic and Proofs", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 7 },
                new lesson { lessonId = 32, lessonTitle = "Set Theory", lessonVideo = "https://estigo.runasp.net/math5.mp4", courseId = 7 },
                new lesson { lessonId = 33, lessonTitle = "Counting Principles", lessonVideo = "https://estigo.runasp.net/math1.mp4", courseId = 7 },
                new lesson { lessonId = 34, lessonTitle = "Relations and Functions", lessonVideo = "https://estigo.runasp.net/math3.mp4", courseId = 7 },
                new lesson { lessonId = 35, lessonTitle = "Introduction to Graph Theory", lessonVideo = "https://estigo.runasp.net/math2.mp4", courseId = 7 },

                // --- Lessons for Course 8: Mechanics | Unit 1 ---
                new lesson { lessonId = 36, lessonTitle = "Kinematics in One Dimension", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 8 },
                new lesson { lessonId = 37, lessonTitle = "Vectors and 2D Kinematics", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 8 },
                new lesson { lessonId = 38, lessonTitle = "Newton's Laws of Motion", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 8 },
                new lesson { lessonId = 39, lessonTitle = "Work, Energy, and Power", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 8 },
                new lesson { lessonId = 40, lessonTitle = "Momentum and Collisions", lessonVideo = "https://estigo.runasp.net/phy5.mp4", courseId = 8 },

                // --- Lessons for Course 9: Electricity | Unit 2 ---
                new lesson { lessonId = 41, lessonTitle = "Electric Charge and Coulomb's Law", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 9 },
                new lesson { lessonId = 42, lessonTitle = "Electric Fields", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 9 },
                new lesson { lessonId = 43, lessonTitle = "Electric Potential", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 9 },
                new lesson { lessonId = 44, lessonTitle = "Capacitance", lessonVideo = "https://estigo.runasp.net/phy14.mp4", courseId = 9 },
                new lesson { lessonId = 45, lessonTitle = "Current, Resistance, and Ohm's Law", lessonVideo = "https://estigo.runasp.net/phy5.mp4", courseId = 9 },

                // --- Lessons for Course 10: Magnetism | Unit 3 ---
                new lesson { lessonId = 46, lessonTitle = "Magnetic Fields and Forces", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 10 },
                new lesson { lessonId = 47, lessonTitle = "Sources of Magnetic Fields", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 10 },
                new lesson { lessonId = 48, lessonTitle = "Ampere's Law", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 10 },
                new lesson { lessonId = 49, lessonTitle = "Electromagnetic Induction", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 10 },
                new lesson { lessonId = 50, lessonTitle = "Inductance", lessonVideo = "https://estigo.runasp.net/phy5.mp4", courseId = 10 },

                // --- Lessons for Course 11: Optics | Unit 4 ---
                new lesson { lessonId = 51, lessonTitle = "Nature of Light", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 11 },
                new lesson { lessonId = 52, lessonTitle = "Reflection and Refraction", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 11 },
                new lesson { lessonId = 53, lessonTitle = "Lenses and Image Formation", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 11 },
                new lesson { lessonId = 54, lessonTitle = "Wave Optics: Interference", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 11 },
                new lesson { lessonId = 55, lessonTitle = "Wave Optics: Diffraction", lessonVideo = "https://estigo.runasp.net/phy5.mp4", courseId = 11 },

                // --- Lessons for Course 12: Thermodynamics | Unit 5 ---
                new lesson { lessonId = 56, lessonTitle = "Temperature and Heat", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 12 },
                new lesson { lessonId = 57, lessonTitle = "First Law of Thermodynamics", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 12 },
                new lesson { lessonId = 58, lessonTitle = "Ideal Gas Law", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 12 },
                new lesson { lessonId = 59, lessonTitle = "Second Law of Thermodynamics", lessonVideo = "https://estigo.runasp.net/phy5.mp4", courseId = 12 },
                new lesson { lessonId = 60, lessonTitle = "Thermodynamic Cycles", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 12 },

                // --- Lessons for Course 13: Quantum Physics | Unit 6 ---
                new lesson { lessonId = 61, lessonTitle = "Blackbody Radiation & Planck's Hypothesis", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 13 },
                new lesson { lessonId = 62, lessonTitle = "Photoelectric Effect", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 13 },
                new lesson { lessonId = 63, lessonTitle = "Wave Nature of Matter", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 13 },
                new lesson { lessonId = 64, lessonTitle = "The Bohr Model", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 13 },
                new lesson { lessonId = 65, lessonTitle = "Introduction to Quantum Mechanics", lessonVideo = "https://estigo.runasp.net/phy5.mp4", courseId = 13 },

                // --- Lessons for Course 14: Relativity | Unit 7 ---
                new lesson { lessonId = 66, lessonTitle = "Principles of Special Relativity", lessonVideo = "https://estigo.runasp.net/phy1.mp4", courseId = 14 },
                new lesson { lessonId = 67, lessonTitle = "Time Dilation and Length Contraction", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 14 },
                new lesson { lessonId = 68, lessonTitle = "Relativistic Momentum and Energy", lessonVideo = "https://estigo.runasp.net/phy4.mp4", courseId = 14 },
                new lesson { lessonId = 69, lessonTitle = "Introduction to General Relativity", lessonVideo = "https://estigo.runasp.net/phy2.mp4", courseId = 14 },
                new lesson { lessonId = 70, lessonTitle = "Consequences of General Relativity", lessonVideo = "https://estigo.runasp.net/phy3.mp4", courseId = 14 },

                // --- Lessons for Course 15: Cell Biology | Unit 1 ---
                new lesson { lessonId = 71, lessonTitle = "Introduction to Cells", lessonVideo = "https://estigo.runasp.net/Bio1.mp4", courseId = 15 },
                new lesson { lessonId = 72, lessonTitle = "Cell Membrane Structure and Function", lessonVideo = "https://estigo.runasp.net/Bio2.mp4", courseId = 15 },
                new lesson { lessonId = 73, lessonTitle = "Eukaryotic Organelles", lessonVideo = "https://estigo.runasp.net/Bio3.mp4", courseId = 15 },
                new lesson { lessonId = 74, lessonTitle = "Cellular Respiration", lessonVideo = "https://estigo.runasp.net/Bio4.mp4", courseId = 15 },
                new lesson { lessonId = 75, lessonTitle = "The Cell Cycle and Mitosis", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 15 },

                // --- Lessons for Course 16: Genetics | Unit 2 ---
                new lesson { lessonId = 76, lessonTitle = "Mendelian Genetics", lessonVideo = "https://estigo.runasp.net/Bio2.mp4", courseId = 16 },
                new lesson { lessonId = 77, lessonTitle = "DNA Structure and Replication", lessonVideo = "https://estigo.runasp.net/Bio1.mp4", courseId = 16 },
                new lesson { lessonId = 78, lessonTitle = "Gene Expression: Transcription", lessonVideo = "https://estigo.runasp.net/Bio3.mp4", courseId = 16 },
                new lesson { lessonId = 79, lessonTitle = "Gene Expression: Translation", lessonVideo = "https://estigo.runasp.net/Bio4.mp4", courseId = 16 },
                new lesson { lessonId = 80, lessonTitle = "Mutations and Genetic Variation", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 16 },

                // --- Lessons for Course 17: Movement | Unit 3 ---
                new lesson { lessonId = 81, lessonTitle = "Skeletal Systems", lessonVideo = "https://estigo.runasp.net/Bio3.mp4", courseId = 17 },
                new lesson { lessonId = 82, lessonTitle = "Muscular Systems", lessonVideo = "https://estigo.runasp.net/Bio2.mp4", courseId = 17 },
                new lesson { lessonId = 83, lessonTitle = "Biomechanics Basics", lessonVideo = "https://estigo.runasp.net/Bio1.mp4", courseId = 17 },
                new lesson { lessonId = 84, lessonTitle = "Locomotion in Animals", lessonVideo = "https://estigo.runasp.net/Bio4.mp4", courseId = 17 },
                new lesson { lessonId = 85, lessonTitle = "Nervous System Control of Movement", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 17 },

                // --- Lessons for Course 18: Ecology | Unit 4 ---
                new lesson { lessonId = 86, lessonTitle = "Introduction to Ecology", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 18 },
                new lesson { lessonId = 87, lessonTitle = "Population Ecology", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 18 },
                new lesson { lessonId = 88, lessonTitle = "Community Ecology", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 18 },
                new lesson { lessonId = 89, lessonTitle = "Ecosystem Dynamics", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 18 },
                new lesson { lessonId = 90, lessonTitle = "Biomes and Conservation", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 18 },

                // --- Lessons for Course 19: Botany | Unit 5 ---
                new lesson { lessonId = 91, lessonTitle = "Plant Structure and Growth", lessonVideo = "https://estigo.runasp.net/Bio1.mp4", courseId = 19 },
                new lesson { lessonId = 92, lessonTitle = "Plant Transport Systems", lessonVideo = "https://estigo.runasp.net/Bio2.mp4", courseId = 19 },
                new lesson { lessonId = 93, lessonTitle = "Photosynthesis", lessonVideo = "https://estigo.runasp.net/Bio3.mp4", courseId = 19 },
                new lesson { lessonId = 94, lessonTitle = "Plant Reproduction", lessonVideo = "https://estigo.runasp.net/Bio4.mp4", courseId = 19 },
                new lesson { lessonId = 95, lessonTitle = "Plant Hormones and Responses", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 19 },

                // --- Lessons for Course 20: Zoology | Unit 6 ---
                new lesson { lessonId = 96, lessonTitle = "Introduction to Animal Diversity", lessonVideo = "https://estigo.runasp.net/Bio1.mp4", courseId = 20 },
                new lesson { lessonId = 97, lessonTitle = "Invertebrate Zoology I", lessonVideo = "https://estigo.runasp.net/Bio2.mp4", courseId = 20 },
                new lesson { lessonId = 98, lessonTitle = "Invertebrate Zoology II", lessonVideo = "https://estigo.runasp.net/Bio3.mp4", courseId = 20 },
                new lesson { lessonId = 99, lessonTitle = "Vertebrate Zoology I", lessonVideo = "https://estigo.runasp.net/Bio4.mp4", courseId = 20 },
                new lesson { lessonId = 100, lessonTitle = "Vertebrate Zoology II", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 20 },

                // --- Lessons for Course 21: Microbiology | Unit 7 ---
                new lesson { lessonId = 101, lessonTitle = "Introduction to Microbes", lessonVideo = "https://estigo.runasp.net/Bio1.mp4", courseId = 21 },
                new lesson { lessonId = 102, lessonTitle = "Bacterial Structure and Function", lessonVideo = "https://estigo.runasp.net/Bio2.mp4", courseId = 21 },
                new lesson { lessonId = 103, lessonTitle = "Microbial Growth and Metabolism", lessonVideo = "https://estigo.runasp.net/Bio3.mp4", courseId = 21 },
                new lesson { lessonId = 104, lessonTitle = "Viruses and Prions", lessonVideo = "https://estigo.runasp.net/Bio4.mp4", courseId = 21 },
                new lesson { lessonId = 105, lessonTitle = "Microbial Roles and Applications", lessonVideo = "https://estigo.runasp.net/Bio5.mp4", courseId = 21 },

                // --- Lessons for Course 22: Organic Chemistry | Unit 1 ---
                new lesson { lessonId = 106, lessonTitle = "Introduction & Bonding", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 22 },
                new lesson { lessonId = 107, lessonTitle = "Alkanes and Cycloalkanes", lessonVideo = "https://estigo.runasp.net/chem2.mp4", courseId = 22 },
                new lesson { lessonId = 108, lessonTitle = "Stereochemistry", lessonVideo = "https://estigo.runasp.net/chem3.mp4", courseId = 22 },
                new lesson { lessonId = 109, lessonTitle = "Introduction to Organic Reactions", lessonVideo = "https://estigo.runasp.net/chem4.mp4", courseId = 22 },
                new lesson { lessonId = 110, lessonTitle = "Alkenes and Alkynes: Structure & Reactivity", lessonVideo = "https://estigo.runasp.net/chem5.mp4", courseId = 22 },

                // --- Lessons for Course 23: Inorganic Chemistry | Unit 2 ---
                new lesson { lessonId = 111, lessonTitle = "Atomic Structure and Periodicity", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 23 },
                new lesson { lessonId = 112, lessonTitle = "Chemical Bonding: Lewis & VSEPR", lessonVideo = "https://estigo.runasp.net/chem2.mp4", courseId = 23 },
                new lesson { lessonId = 113, lessonTitle = "Valence Bond and Molecular Orbital Theory", lessonVideo = "https://estigo.runasp.net/chem3.mp4", courseId = 23 },
                new lesson { lessonId = 114, lessonTitle = "Acid-Base Chemistry", lessonVideo = "https://estigo.runasp.net/chem4.mp4", courseId = 23 },
                new lesson { lessonId = 115, lessonTitle = "Introduction to Coordination Chemistry", lessonVideo = "https://estigo.runasp.net/chem5.mp4", courseId = 23 },

                // --- Lessons for Course 24: Physical Chemistry | Unit 3 ---
                new lesson { lessonId = 116, lessonTitle = "Gases and Kinetic Theory", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 24 },
                new lesson { lessonId = 117, lessonTitle = "Thermodynamics: First Law", lessonVideo = "https://estigo.runasp.net/chem2.mp4", courseId = 24 },
                new lesson { lessonId = 118, lessonTitle = "Thermodynamics: Second & Third Laws", lessonVideo = "https://estigo.runasp.net/chem3.mp4", courseId = 24 },
                new lesson { lessonId = 119, lessonTitle = "Chemical Kinetics", lessonVideo = "https://estigo.runasp.net/chem4.mp4", courseId = 24 },
                new lesson { lessonId = 120, lessonTitle = "Introduction to Quantum Chemistry", lessonVideo = "https://estigo.runasp.net/chem5.mp4", courseId = 24 },

                // --- Lessons for Course 25: Analytical Chemistry | Unit 4 ---
                new lesson { lessonId = 121, lessonTitle = "Introduction & Statistics", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 25 },
                new lesson { lessonId = 122, lessonTitle = "Gravimetric and Volumetric Analysis", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 25 },
                new lesson { lessonId = 123, lessonTitle = "Spectroscopic Methods", lessonVideo = "https://estigo.runasp.net/chem2.mp4", courseId = 25 },
                new lesson { lessonId = 124, lessonTitle = "Chromatography Basics", lessonVideo = "https://estigo.runasp.net/chem3.mp4", courseId = 25 },
                new lesson { lessonId = 125, lessonTitle = "Electroanalytical Methods", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 25 },

                // --- Lessons for Course 26: Biochemistry | Unit 5 ---
                new lesson { lessonId = 126, lessonTitle = "Amino Acids and Proteins", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 26 },
                new lesson { lessonId = 127, lessonTitle = "Enzymes and Enzyme Kinetics", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 26 },
                new lesson { lessonId = 128, lessonTitle = "Carbohydrates", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 26 },
                new lesson { lessonId = 129, lessonTitle = "Lipids and Membranes", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 26 },
                new lesson { lessonId = 130, lessonTitle = "Metabolic Pathways Overview", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 26 },

                // --- Lessons for Course 27: Environmental Chemistry | Unit 6 ---
                new lesson { lessonId = 131, lessonTitle = "Atmospheric Chemistry", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 27 },
                new lesson { lessonId = 132, lessonTitle = "Aquatic Chemistry", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 27 },
                new lesson { lessonId = 133, lessonTitle = "Soil Chemistry", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 27 },
                new lesson { lessonId = 134, lessonTitle = "Toxicology and Risk Assessment", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 27 },
                new lesson { lessonId = 135, lessonTitle = "Green Chemistry", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 27 },

                // --- Lessons for Course 28: Theoretical Chemistry | Unit 7 ---
                new lesson { lessonId = 136, lessonTitle = "Quantum Mechanics Fundamentals", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 28 },
                new lesson { lessonId = 137, lessonTitle = "Approximation Methods", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 28 },
                new lesson { lessonId = 138, lessonTitle = "Molecular Symmetry and Group Theory", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 28 },
                new lesson { lessonId = 139, lessonTitle = "Computational Chemistry Methods", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 28 },
                new lesson { lessonId = 140, lessonTitle = "Statistical Thermodynamics", lessonVideo = "https://estigo.runasp.net/chem1.mp4", courseId = 28 },

                // --- Lessons for Course 29: Literature | Unit 1 ---
                new lesson { lessonId = 141, lessonTitle = "Introduction to Literary Analysis", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 29 },
                new lesson { lessonId = 142, lessonTitle = "Short Story Analysis", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 29 },
                new lesson { lessonId = 143, lessonTitle = "Poetry Fundamentals", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 29 },
                new lesson { lessonId = 144, lessonTitle = "Novel Study: Introduction", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 29 },
                new lesson { lessonId = 145, lessonTitle = "Introduction to Drama", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 29 },

                // --- Lessons for Course 30: Creative Writing | Unit 2 ---
                new lesson { lessonId = 146, lessonTitle = "Finding Your Voice", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 30 },
                new lesson { lessonId = 147, lessonTitle = "Character Development", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 30 },
                new lesson { lessonId = 148, lessonTitle = "Plotting and Structure", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 30 },
                new lesson { lessonId = 149, lessonTitle = "Setting and Description", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 30 },
                new lesson { lessonId = 150, lessonTitle = "Dialogue Writing", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 30 },

                // --- Lessons for Course 31: Grammar & Composition | Unit 3 ---
                new lesson { lessonId = 151, lessonTitle = "Parts of Speech Review", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 31 },
                new lesson { lessonId = 152, lessonTitle = "Sentence Structure", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 31 },
                new lesson { lessonId = 153, lessonTitle = "Punctuation Rules", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 31 },
                new lesson { lessonId = 154, lessonTitle = "Common Grammatical Errors", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 31 },
                new lesson { lessonId = 155, lessonTitle = "Paragraph and Essay Structure", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 31 },

                // --- Lessons for Course 32: Poetry Analysis | Unit 4 ---
                new lesson { lessonId = 156, lessonTitle = "Elements of Poetry", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 32 },
                new lesson { lessonId = 157, lessonTitle = "Figurative Language", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 32 },
                new lesson { lessonId = 158, lessonTitle = "Sound Devices", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 32 },
                new lesson { lessonId = 159, lessonTitle = "Poetic Forms", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 32 },
                new lesson { lessonId = 160, lessonTitle = "Interpreting Poems", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 32 },

                // --- Lessons for Course 33: Drama & Theater | Unit 5 ---
                new lesson { lessonId = 161, lessonTitle = "History of Theater", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 33 },
                new lesson { lessonId = 162, lessonTitle = "Elements of Drama", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 33 },
                new lesson { lessonId = 163, lessonTitle = "Reading a Play", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 33 },
                new lesson { lessonId = 164, lessonTitle = "Major Dramatic Genres", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 33 },
                new lesson { lessonId = 165, lessonTitle = "Theater Production Basics", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 33 },

                // --- Lessons for Course 34: Fiction Writing | Unit 6 ---
                new lesson { lessonId = 166, lessonTitle = "Generating Ideas", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 34 },
                new lesson { lessonId = 167, lessonTitle = "Point of View and Narrative Voice", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 34 },
                new lesson { lessonId = 168, lessonTitle = "Show, Don't Tell", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 34 },
                new lesson { lessonId = 169, lessonTitle = "Crafting Scenes", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 34 },
                new lesson { lessonId = 170, lessonTitle = "Revision Strategies", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 34 },

                // --- Lessons for Course 35: Non-fiction Writing | Unit 7 ---
                new lesson { lessonId = 171, lessonTitle = "Types of Non-fiction", lessonVideo = "https://estigo.runasp.net/Eng1.mp4", courseId = 35 },
                new lesson { lessonId = 172, lessonTitle = "Research Techniques", lessonVideo = "https://estigo.runasp.net/Eng2.mp4", courseId = 35 },
                new lesson { lessonId = 173, lessonTitle = "Structuring Non-fiction", lessonVideo = "https://estigo.runasp.net/Eng3.mp4", courseId = 35 },
                new lesson { lessonId = 174, lessonTitle = "Writing with Clarity and Style", lessonVideo = "https://estigo.runasp.net/Eng4.mp4", courseId = 35 },
                new lesson { lessonId = 175, lessonTitle = "Ethics in Non-fiction", lessonVideo = "https://estigo.runasp.net/Eng5.mp4", courseId = 35 }
                );
